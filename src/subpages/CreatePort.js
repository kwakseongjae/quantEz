...
export const CreatePort = () => {
    ...
    <>
    <div
      class="pop pop-conditional pop-style-1"
      id="divPopCond"
      style={{ display: "none" }}
    >
      <div class="pop-bg" />
      <div class="pop-in">
        <div class="btn_cls pop-close" onclick="popupCondition()">
        ...
        <div class="pop-content">
          <div class="mb-10">
            ...
            />
            <span class="btn button-search mr-10" />
            <button
              type="button"
              class="btn_small btn_white mr-5"
          ...
          {/* 검색박스 */}
          {/* 조건박스 시작 */}
          <div class="input-conditional-content">
            {/* 왼쪽 박스 */}
            <div
              class="fl box_condLeft"
              id="ConditionTreeDiv"
              tabindex="0"
              onkeyup="Component.MPortUI.searchPopCondition();"
            >
              <ul id="ConditionTree">
                <li id="cmain0" class="depth1">
                  <img src="../img/icn_folderOpen.png" />
                  <span class="subtitle_15px">종합</span>
                </li>
                <li
                  id="csub00"
                  class="depth2"
                ...
                >
                  <span class="infotxt_15px">
                    <img id="csubimg00" src="img/icn_folderClose.png" />
                    종합점수
                  </span>
                </li>
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">종합점수</span>
                </li>
                <li
                  id="citem001"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">종합점수순위</span>
                </li>
                <li
                  id="csub01"
                  class="depth2"
                ...
                >
                  <span class="infotxt_15px">
                    <img id="csubimg01" src="img/icn_folderClose.png" />
                    업종종합점수
                  </span>
                </li>
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">업종종합점수순위</span>
                </li>
                <li
                  id="citem011"
                  class="depth3"
                ...
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">업종별종합순위점수</span>
                </li>
                <li id="cmain1" class="depth1">
                  <img src="../img/icn_folderOpen.png" />
                  <span class="subtitle_15px">모멘텀</span>
                </li>
                <li
                  id="csub10"
                  class="depth2"
                ...
                >
                  <span class="infotxt_15px">
                    <img id="csubimg10" src="../img/icn_folderClose.png" />
                    모멘텀
                  </span>
                </li>
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">모멘텀점수</span>
                </li>
                <li
                  id="citem101"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">모멘텀점수순위</span>
                </li>
                <li
                  id="citem102"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">업종모멘텀점수</span>
                </li>
                <li
                  id="citem103"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">업종모멘텀점수순위</span>
                </li>
                <li
                  id="citem104"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">업종별모멘텀순위점수</span>
                </li>
                <li
                  id="citem105"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">모멘텀첫A</span>
                </li>
                <li
                  id="citem106"
                  class="depth3"
                ...
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">모멘텀A-연속</span>
                </li>
                <li
                  id="citem108"
                  class="depth3"
                ...
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">베타</span>
                </li>
                <li
                  id="csub11"
                  class="depth2"
                ...
                >
                  <span class="infotxt_15px">
                    <img id="csubimg11" src="../img/icn_folderClose.png" />
                    가격
                  </span>
                </li>
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">가격점수</span>
                </li>
                <li
                  id="citem111"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">상승강도점수</span>
                </li>
                <li
                  id="citem112"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">VRAC점수</span>
                </li>
                <li
                  id="citem113"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">이격도점수</span>
                </li>
                <li
                  id="citem114"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">이격도</span>
                </li>
                <li
                  id="citem115"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">시가</span>
                </li>
                <li
                  id="citem116"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">고가</span>
                </li>
                <li
                  id="citem117"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">저가</span>
                </li>
                <li
                  id="citem118"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">종가</span>
                </li>
                <li
                  id="citem119"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">종가시초가대비율</span>
                </li>
                <li
                  id="citem1110"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">일별주가상승률</span>
                </li>
                <li
                  id="citem1111"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">주간주가상승률1주전</span>
                </li>
                <li
                  id="citem1112"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">월간주가상승률1개월전</span>
                </li>
                <li
                  id="citem1113"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">골든크로스(20일/60일)</span>
                </li>
                <li
                  id="citem1114"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">주가이동평균변화율</span>
                </li>
                <li
                  id="citem1115"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">신고가갱신(52주)</span>
                </li>
                <li
                  id="citem1116"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">신저가갱신(52주)</span>
                </li>
                <li
                  id="citem1117"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">당일고가대비저가변동비율</span>
                </li>
                <li
                  id="citem1118"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">최저가대비상승비율</span>
                </li>
                <li
                  id="citem1119"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">최고가대비하락비율</span>
                </li>
                <li
                  id="citem1120"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">피보나치상승율</span>
                </li>
                <li
                  id="citem1121"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">피보나치하락율</span>
                </li>
                <li
                  id="citem1122"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">일별주가상승율250일변동성</span>
                </li>
                <li
                  id="csub12"
                  class="depth2"
                ...
                >
                  <span class="infotxt_15px">
                    <img id="csubimg12" src="../img/icn_folderClose.png" />
                    수급
                  </span>
                </li>
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">수급점수</span>
                </li>
                <li
                  id="citem121"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">기관수급점수</span>
                </li>
                <li
                  id="citem122"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">외국인수급점수</span>
                </li>
                <li
                  id="citem123"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">기관누적순매수점수</span>
                </li>
                <li
                  id="citem124"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">외국인누적순매수점수</span>
                </li>
                <li
                  id="citem125"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">거래비율점수2</span>
                </li>
                <li
                  id="citem126"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">거래대금(거래소별)점수</span>
                </li>
                <li
                  id="citem127"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">20일평균거래대금점수</span>
                </li>
                <li
                  id="citem128"
                  class="depth3"
                ...
                <li
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">거래대금</span>
                </li>
                <li
                  id="citem1210"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">시가총액상위50%이상</span>
                </li>
                <li
                  id="citem1211"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">거래대금상위50%이상</span>
                </li>
                <li
                  id="citem1212"
                  class="depth3"
                  ...
                  style={{ display: "none" }}
                >
                  <span class="infotxt_15px">거래량</span>
                </li>
              </ul>
            </div>
          </div>
    ...
    {/* 메인 콘텐츠 */}
    <div id="content">
      <div class="area_location" id="locNewPort">
        <ul>
          <li class="fl">
            <p class="fl title">월봉 백테스팅 포트 만들기</p>
            <p class="fl info">
      ...
      <div class="area_content">
        ...
        <div class="section_flowTab">
          <ul>
            <li id="tabMenu0" style={{ width: "50%" }} class="on">
              <p>Step.1 기본 설정</p>
              <span>기본 조건들을 설정하세요.</span>
            </li>
            <li id="tabMenu1" style={{ width: "50%" }} class>
              <p>Step 2. 포트 완성!</p>
        ...
        {/* flow tab */}
        <div id="NewPortSection0">
          <div class="section_newport">
            {/* 포트 제목, 포트 설명 */}
            <div class="port_subBox mt-0">
              <div class="fl box-port-title">
                <p class="subtitle_16px">포트 제목</p>
                <div>
                  <input
                    type="text"
                    id="Name"
              ...
              <div class="fr box-port-description">
                <p class="subtitle_16px">
                  포트 설명
                  <span
                    class="infotxt_12px666"
            ...
            {/* 포트 제목, 포트 설명 */}
            {/* 기본 조건 */}
            <div class="port_subBox">
              <ul>
                <li class="subtitle_16px">기본 조건</li>
                <table
                  class="fl tbl_vertical"
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      <td class="new-port-step1 taC">
                        <input
                          type="text"
                          id="startAsset"
                          class="text_extrasmall taR"
                          placeholder="5,000"
                          value="5,000"
                          onkeydown="return inputCheckNumOnly(event);"
                          style={{ width: "70px" }}
                        />
                        <span class="bold ml8px" id="StartAssetUnit">
                          만원
                        </span>
                      </td>
                    </tr>
                      ...
                      <td class="new-port-step1 taC">
                        <p>
                          <input
                            type="text"
                            id="StartDate"
                            class="text_medium taC monthpickerSet mtz-monthpicker-widgetcontainer"
                            freedate="20220524"
                          />
                          <span class="bold ml8px mr8px">부터</span>
                          <input
                            type="text"
                            id="EndDate"
                            class="text_medium taC monthpickerSet mtz-monthpicker-widgetcontainer"
                            ...
                            maxdate="2023/05/23"
                          />
                          <span class="bold ml8px">까지</span>
                        </p>
                      </td>
                    </tr>
                  </tbody>
                </table>
                <table class="fl tbl_vertical" style={{ width: "220px" }}>
                  <colgroup>
                    <col style={{ width: "220px" }} />
                  </colgroup>
                  <thead>
                    ...
                    <tr>
                      <td class="new-port-step1 taC">
                        <input
                          ...
                          onkeydown="return inputCheckNumOnly(event);"
                        />
                        <span class="bold ml8px">%</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
                <table class="fr tbl_vertical" style={{ width: "220px" }}>
                  <colgroup>
                    <col style={{ width: "220px" }} />
                  </colgroup>
                  <thead>
            ...
            <div class="port_subBox">
              {/* 매수조건 */}
              <div class="fl box_tradeCondition" style={{ width: "74%" }}>
                <ul>
                  <li class="subtitle_15px">
                    <span class="txt_plus">매수조건</span>
                  </li>
                  <table
                    class="tbl_vertical"
                    style={{ marginBottom: "10px" }}
                    id="tblBuyPriceTypeNormal"
                  >
                    <thead>
                      <tr>
                        <th class="buy">매수 가격기준</th>
                        <th class="buy">최대 보유종목 수</th>
                        <th class="buy">리밸런싱 기간</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td class="taC blR">
                          ...
                          <input
                            type="text"
                            id="BuyPriceVal"
                            class="text_extrasmall taL ml4px"
                            style={{ borderRadius: "3px 0px 0px 3px" }}
                            value="+5.0"
                            onkeydown="return inputCheckNumOnly(event);"
                          />
                          <span class="bold ml4px">%</span>
                        </td>
                        <td class="taC blR">
                          <input
                            type="text"
                            ...
                            onkeydown="return inputCheckNumOnly(event);"
                          />
                          <span class="bold ml4px">종목</span>
                        </td>
                        <td class="taC">
                          <div class="ml4px">
                            <select
                              id="ReBalancingCycle"
                              class="select_newport"
                            >
              ...
              {/* 매수조건 */}
              {/* 매도조건 */}
              <div class="fr box_tradeCondition" style={{ width: "24%" }}>
                <ul>
                  <li class="subtitle_15px">
                    <span class="txt_minus">매도조건</span>
                  </li>
                  <table
                    class="tbl_vertical"
                    style={{ marginBottom: "10px" }}
            ...
            <div class="port_subBox">
              <ul>
                <li>
                  <span class="subtitle_16px mr20px">유니버스 선택</span>
                  <button type="button" class="btn_small btn_white">
                    전체선택
                  </button>
                  <button type="button" class="btn_small btn_white">
                    선택해제
                ...
                <li id="section_univ" class="box_universe">
                  <p>
                    <input
                      type="checkbox"
                      id="cbUnivKOSPIML-ALL"
                      class="check_np cbuniv"
                      checked="checked"
                    />
                    <label for="cbUnivKOSPIML-ALL" class="checkbox_label_np">
                      코스피 중대형
                    </label>
                  </p>
                  <p>
                    <input
                      type="checkbox"
                      id="cbUnivKOSPIMS-ALL"
                      class="check_np cbuniv"
                      checked="checked"
                    />
                    <label for="cbUnivKOSPIMS-ALL" class="checkbox_label_np">
                      코스피 중소형
                    </label>
                  </p>
                  <p>
                    <input
                      ...
                      checked="checked"
                    />
                    <label for="cbUnivKOSDAQL" class="checkbox_label_np">
                      코스닥 대형
                    </label>
                  </p>
                  <p>
                    <input
                      ...
                      checked="checked"
                    />
                    <label for="cbUnivKOSDAQM" class="checkbox_label_np">
                      코스닥 중형
                    </label>
                  </p>
                  <p>
                    <input
                      ...
                      checked="checked"
                    />
                    <label for="cbUnivKOSDAQS" class="checkbox_label_np">
                      코스닥 소형
                    </label>
                  </p>
                  <p>
                    <input
                      ...
                      checked="checked"
                    />
                    <label for="cbUnivKOSDAQXS" class="checkbox_label_np">
                      코스닥 초소형
                    </label>
                  </p>
                  <p>
                    <input
                      ...
                      class="check_np cbuniv"
                    />
                    <label for="cbUnivETF" class="checkbox_label_np">
                      ETF
                    </label>
                  </p>
                </li>
            ...
            {/* 매수조건식 */}
            <div class="port_subBox">
              <div class="subtitle_15px mb-10">
                <span class="txt_plus mr-20">매수조건식 선택</span>
                <button
                  type="button"
                  class="btn_white btn-m"
                ...
                <button
                  type="button"
                  class="btn_purple btn-m"
                  style={{ lineHeight: "15px", width: "auto" }}
                >
                  저장하기
                </button>
              </div>
              <div class="newport_conditionBox">
                <ul id="section_buy_condition">
                  <li class="fl addCondition" onclick="popupCondition()">
                    <p>
                      <span class="button_addCondition">+</span>
                      <span class="infotxt_13px333 bold ml8px">
                        조건식 추가하기
                      </span>
                    </p>
                  </li>
            ...
            {/* 매수 조건식 */}
            {/* 매수 조건식 설정 */}
            <div class="port_subBox" style={{ marginTop: "20px" }}>
              <div class="subtitle_15px">매수조건식 설정</div>
              <div class="box_padding20" style={{ overflow: "hidden" }}>
                {/* 조건식 입력 */}
                <div class="box_conditionInput">
                  <div class="box-conditionInput-l">
                    <div>
                      <input
                        type="text"
                        id="BuyCondExp"
                    ...
                    <p class="subtitle_14px" id="BuyCondExpTxt"></p>
                  </div>
                  <div class="box-conditionInput-r">
                    <div class="mb-5">
                      <button
                        type="button"
                        class="ml4px btn_medium btn_white"
                      >
                        조건식 설정안내
                      </button>
                      <button type="button" class="btn_medium btn_purple">
                        조건식 검증하기
                      </button>
                    </div>
                  </div>
              ...
              <table class="tbl_horizon" style={{ marginTop: "10px" }}>
                <colgroup>
                  <col style={{ width: "160px" }}></col>
                </colgroup>
                <tbody>
                  <tr>
                    <th class="buy">매수종목 우선순위</th>
                    <td>
                      <input
                        type="text"
                        id="BaseOrderColumn"
                      ...
                      <label
                        ...
                        class="css-label radGroup1 radGroup2 mr-10"
                      >
                        내림차순(높은 값부터)↓
                      </label>
                      <input
                      ...
                      <label
                        for="BaseOrderDirASC"
                        class="css-label radGroup1 radGroup2"
                      >
                        오름차순(낮은 값부터)↑
                      </label>
                    </td>
              ...
              <table class="tbl_horizon" style={{ marginTop: "10px" }}>
                ...
                <tbody>
                  <tr>
                    <th class="buy">매수종목 2차 우선순위</th>
                    <td>
                      <input type="checkbox" id="BaseOrder2Use" />
                      ...
                      <button
                        type="button"
                        class="btn_purple btn_medium mr-30"
                        style={{
                          lineHeight: "15px",
                          width: "auto",
                          display: "none",
          ...
          <div class="run_backtest_button" style={{ marginTop: "30px" }}>
            <button
              id="btnExecBTE"
              type="button"
              class="btn_extralarge btn_purple ml8px"
            >
