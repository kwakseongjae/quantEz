    ...
    <div className={cx("popular-categories")}>
      <div className={cx("container")}>
        <div className={cx("row")}>
          ...
          <div className={cx("col-lg-12")}>
            <div className={cx("naccs")}>
              <div className={cx("grid")}>
                <div className={cx("row")}>
                  <div className={cx("col-lg-3")}>
                    <div className={cx("menu")}>
                      <div className={cx('firstthumb', 'active')}>
                  ...
                  <div className={cx("col-lg-9", "align-self-center")}>
                    <ul className={cx("nacc")}>
                      <li className={cx("active")}>
                        <div>
                          <div className={cx("thumb")}>
                            <div className={cx("row")}>
                              <div
                                className={cx("col-lg-5", "align-self-center")}
                              >
                                <div className={cx("left-text")}>
                                  <h4 className={cx("category-head")}>
                                  ...
                                  <div className={cx("main-white-button")}>
                                    <Link
                                      className={cx("FSstart")}
                                      to="/financeSheetlist/financeSheet"
                                    >
                                      <i className={cx("fa", "fa-eye")}></i>학습
                                      시작하기
                                    </Link>
                                  </div>
                                </div>
                              ...
                              <div
                                className={cx("col-lg-7", "align-self-center")}
                              >
